...
console.log(alumnos[0] + " tiene " + notas[0] + " en programacion y juega " + juegos[0])

console.log(alumnos[1] + " tiene " + notas[2] + " en programacion y juega " + juegos[1])

const  calcularCuadradoDeNumbers = (numero1, numero2) => {
    const cuadradoNumero1 = +numero1*+numero1 
    const cuadradoNumero2 = +numero2*+numero2 

    return `cuadrado de numero1 ${cuadradoNumero1} y cuadrado de numero2 ${cuadradoNumero2}`
 
}
console.log(cuadradoDeNumers(10,2))
...
const verificarSiEsMAyorDeEdad  = (edad) => {
    /*if (edad>=18) {
    ...
    return edad>=18 ? "es mayor edad" : "es menor de edad"
}
