...
console.log("Mascotas edad Par",mascotasEdadPar)*/
...
const cursoJS = arregloCursos.filter ((curso) => curso.tec ==="JS")
const cursoPython = arregloCursos.filter ((curso) => curso.tec ==="Python")
const cursoPHP = arregloCursos.filter ((curso) => curso.tec ==="PHP")
